...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	<div class="container"> 
	  ...
	  <div class="collapse navbar-collapse" id="ftco-nav">
		<ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link"><form action="form/logout.php" method="POST">
          <button name="logout" class="btn btn-danger">Logout</button></form></a></li>
		</ul>
	  </div>
	</div>
  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            <h1 class="mb-0 bread">Student Counseling Centre</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				<div class="row"> <h4 style="text-align: center; margin-bottom: 50px;">Our online counseling services are best specialised to meet you at the point of need. Please select a category to get started.</h4>

					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_academic_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/academically\ challenged\ student.jpg);"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_anxeitydepression_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/troubled\ man.jpeg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Anxeity/Depression</h3>
							</div>
						</div>
						</a>
					</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_family_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/care&believe.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Family Crisis</h3>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_financial_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/financial\ crisis.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_general_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/phobia.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_relationship_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/relationship\ trouble.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_sexuality_session_.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/depreesed\ person.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Sex and Violence</h3>
							</div>
						</div>
						</a>
					</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<a href="online_vocational_session.php">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/images/career.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Vocation/Career Crisis</h3>
							</div>
						</div>
						</a>
					</div>
		...
		<section class="ftco-section ftco-no-pt bg-light">
			<div class="container">
			  ...
			  <div class="col-md-7 heading-section text-center ftco-animate">
				...
				<p>You can explore other available options of getting similar support if our specialists are unavoidably available or engaged by another client.</p>
			  </div>
			</div>
