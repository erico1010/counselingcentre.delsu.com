...
<html lang="en">
  <head>
    <title>Counselor Anxeity Depression - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            <h1 class="mb-0 bread">Anxeity &amp; Depression Support</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
        <div class="container"> <br><h2>We care about you and we committed to help. We have specialists to help you</h2><br><br>
            <div class="row">

                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/images/prof\ Jude.jpg);"></div>
                        </div>
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>Rev. Fr. Jude J. Obiunu</h3>
                            <span class="position mb-2">Director, Counseling Centre <p>Professor of Guidace and Counseling</p> <p>PhD. Guidance and Counseling</p> </span>
                            <div class="faded">
                                <p>I am a Catholic Priest lecturing in the Department of Guidance and Counselling. I have a passion for listening to and helping people experiencing one challenge or another.</p>
        ...
        <section>
            <div class="livechat" style="height: 300px; background-color: rgb(2, 23, 37); text-align: center; padding-top: 80px;">
                <h2>Starting A Discussion</h2>
                <p>Click on the icon on the bottom right corner of this page. A counselor is waiting to receive you</p>
    <!--Start of Tawk.to 
    CURRENTLY RECIEVED BY NILANTHONIO@GMAIL.COM   Script-->
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/61d2182b80b2296cfdd4ba50/1foeasut4';
        s1.charset='UTF-8';
		...
		<section class="ftco-section ftco-no-pt bg-light">
            <div class="container">
              ...
              <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>Our services is for the entire Delsu Community. Our online therapists will reply to your messages and start a discussion with you shortly. While you wait patiently for the next available counselor, you can explore other options of getting help.</p>
              </div>
            </div>
