	...
	<div class="container"> 
	  ...
	  <div class="collapse navbar-collapse" id="ftco-nav">
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item"><a href="login.php" class="nav-link btn btn-primary">Login</a></li>
		</ul>
	  </div>
	</div>
  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            ?>
			<div class="loginform">
				<form action="form/phpmail.php" method="POST" style="color: rgb(220, 222, 255);">
					<label for="Username">Full Name</label>
					<input type="text" name="name" id="userInput" placeholder="e.g Obine Eric Chukwuka" style="width: 85%; text-align: center;">
					<br><br>
					<label for="email">Unique Mail</label>
					<input type="email"  name="email" id="userInput" placeholder="e.g obine.eric@delsu.edu.ng"  style="width: 85%; text-align: center;">
					<br><br>
					<button onclick="name" style="border-radius: 10%;" name="submit">Submit</button><a href=""></a>
				</form>
			</div>
